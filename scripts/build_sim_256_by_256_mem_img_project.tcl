...
puts ""
puts "Running IP creation script for 256x256 image ..."

# These variables are intentionally available to create_sim_256_by_256_mem_img_ip.tcl
...
source [file join $script_dir "create_sim_256_by_256_mem_img_ip.tcl"]
