...
puts ""
puts "Running IP creation script for 64x64 image ..."

# These variables are intentionally available to create_sim_64_by_64_mem_img_ip.tcl
...
source [file join $script_dir "create_sim_64_by_64_mem_img_ip.tcl"]
