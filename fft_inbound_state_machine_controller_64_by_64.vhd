...
--constant for 64 by 64
constant FFTSIZE64 : integer := 61; -- Make two less for pipeline latency to be applied
constant DELAY4    : integer := 4;
constant DELAY32   : integer := 32;
constant DELAY64   : integer := 64;
          ...
          case ps_controller is
            ...
            when state_proc_fft =>
            	...
            	if  (s_axis_data_trdy_i = '1' ) then  -- This means ready ???
            		if ( state_counter_1_r < FFTSIZE64) then
            			 ns_controller <= state_proc_fft;  
            	  else
            ...
            when state_read_done2 =>
            	...
            	elsif ( state_counter_2_r < DELAY32) then 
